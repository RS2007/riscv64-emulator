...
asm: test_add.s test_load_store.s
	...
	riscv64-unknown-elf-as -o test_shift_bits_family.o test_shift_bits_family.s
	...
	riscv64-unknown-elf-ld -o test_shift_bits_family.elf -T linker.ld test_shift_bits_family.o
	...
	riscv64-unknown-elf-objcopy -O binary test_shift_bits_family.elf test_shift_bits_family.bin
